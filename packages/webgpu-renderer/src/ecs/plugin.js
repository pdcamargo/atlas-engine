import { createSet, SystemType } from "@atlas/core";
...
export class WebgpuRendererPlugin {
    options;
    constructor(options) {
    ...
    async build(app) {
        ...
        app
            ...
            .addSystems(SystemType.PreUpdate, createSet(LoadingSystem, textureLoadingSystem, tileSetLoadingSystem))
            .addSystems(SystemType.Update, createSet(AnimationSystem, animationUpdateSystem, tileMapAnimationUpdateSystem, particleUpdateSystem))
            .addSystems(SystemType.Render, createSet(RenderSystem, render));
    }
    ready(app) {
        return (app.hasResource(WebgpuRenderer) &&
