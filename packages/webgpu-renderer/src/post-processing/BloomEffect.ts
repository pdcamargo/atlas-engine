...
export class BloomEffect extends PostProcessEffect {
  ...
  private combineLayout?: GPUBindGroupLayout;

  // Uniform buffers
  private brightPassUniformBuffer?: GPUBuffer;
  private blurHorizontalUniformBuffer?: GPUBuffer;
  private blurVerticalUniformBuffer?: GPUBuffer;
  private combineUniformBuffer?: GPUBuffer;
