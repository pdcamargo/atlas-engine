 ...
 */
export async function runAllExamples(device) {
    console.log("\n╔════════════════════════════════════════════════════════╗");
    ...
    const { runOneShotExample, conditionalExecutionExample } = await import("./one-shot");
    const { runGameOfLifeExample, runGliderExample } = await import("./game-of-life");
    try {
