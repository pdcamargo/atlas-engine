 ...
 */
async function simulateUserClick(worker, clickNumber) {
 ...
 * Example usage
 */
export async function runOneShotExample(device) {
 ...
 */
export async function conditionalExecutionExample(device) {
