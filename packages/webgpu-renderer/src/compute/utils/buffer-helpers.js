 ...
 */
export function toTypedArray(data) {
 ...
 */
export function getBufferSize(data) {
 ...
 */
export function alignBufferSize(size, alignment = 16) {
 ...
 */
export function createStagingBuffer(device, data, label) {
    const typedArray = toTypedArray(data);
    const size = typedArray.byteLength;
 ...
 */
export async function readBuffer(device, sourceBuffer, readbackBuffer, size) {
