 ...
 */
export declare class InstancedSprite extends Sprite {
    private _cachedWorldPosition;
    private _cachedWorldScale;
    private _worldCacheDirty;
    constructor(texture?: Texture | null, width?: number, height?: number, id?: string);
    /**
...
//# sourceMappingURL=InstancedSprite.d.ts.map