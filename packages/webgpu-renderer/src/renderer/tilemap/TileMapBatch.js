...
export class TileMapBatch {
    ...
    device;
    instanceCount = 0;
    bufferId; // Unique ID for bind group caching (globally unique)
     ...
     */
    addTile(x, y, tile, layerIndex, tint = Color.white()) {
     ...
     */
    rebuild(vpMatrix, worldMatrix, tileWidth, tileHeight) {
