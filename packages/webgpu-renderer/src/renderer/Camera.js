...
export class Camera {
    ...
    _viewProjectionMatrix = new Mat4();
    _viewDirty = true;
     ...
     */
    updateViewMatrix() {
        mat4.lookAt(this._viewMatrix.data, this.position.data, this.target.data, this.up.data);
...
export class PerspectiveCamera extends Camera {
    ...
    isInView(sprite) {
        ...
        const distance = Math.sqrt(toSprite.x * toSprite.x +
        ...
        // Normalize vectors
        const viewDirLen = Math.sqrt(viewDir.x * viewDir.x + viewDir.y * viewDir.y + viewDir.z * viewDir.z);
        ...
        const dot = viewDir.x * toSprite.x + viewDir.y * toSprite.y + viewDir.z * toSprite.z;
        ...
        const spriteRadius = Math.sqrt(sprite.width * sprite.width + sprite.height * sprite.height) /
            2;
