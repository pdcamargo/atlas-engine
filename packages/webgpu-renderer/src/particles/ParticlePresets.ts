...
import { ParticleBlendMode } from "./ParticleConfig";
...
export class ParticlePresets {
  ...
  static fire(
    config: {
      ...
      intensity?: number; // 0-1, affects emission rate and size
    } = {}
  ): ParticleEmitter {
    ...
    return new ParticleEmitter({
      ...
      blendMode: "additive" as ParticleBlendMode,
    });
  }
  ...
  static smoke(
    ...
    return new ParticleEmitter({
      ...
      blendMode: "normal" as ParticleBlendMode,
    });
  }
