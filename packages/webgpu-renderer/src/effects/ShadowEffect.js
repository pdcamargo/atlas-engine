...
import { Color, Vector2 } from "@atlas/core";
...
export class ShadowEffect extends Effect {
    ...
    uniformBuffer;
    shadowColor;
    distance; // 0 = on ground, 1 = high above ground
    offset; // Shadow offset from sprite bottom-center
    pixelation; // Pixelation factor (1 = no pixelation, higher = more pixelated)
    scale; // Shadow scale (x = width scale, y = height scale)
    constructor(config = {}) {
